...
router.get(urls.AUTH_FORGET_PASSWORD_API_URL, validators.forgetPasswordTokenValidators(), authController.verifyForgetPasswordToken);
router.post(urls.AUTH_FORGET_PASSWORD_CHANGE_PASSWORD_API_URL, validators.confirmPasswordValidators(), authController.changePasswordAfterForgeting);
