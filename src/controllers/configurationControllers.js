...
function updateContactType(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.updateContactType(updatedContactType)
			.then((contactType) => {
		...
		configurationService
			...
			.then((deleteCount) => {
				...
				if (deleteCount === originalSize) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_CONTACT_TYPE_DELETE_SUCCESS_MESSAGE;
				} else {
					responseJson.code =
						messageConstants.CONFIG_CONTACT_TYPE_DELETED_NOT_ALL_CODE;
...
function getAcademicRanksWithPagination(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.getAcademicRankWithPagination(pageOffset, limitSize)
			.then((academicRanks) => {
				//If there is a not-null academic ranks => change the response's data
				if (academicRanks) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACADEMIC_RANK_SUCCESS_MESSAGE;
...
function createAcademicRanks(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.createAcademicRanks(data)
			.then((academicRankIds) => {
				//If there is a not empty id array => change the response's data
				if (academicRankIds.length > 0) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACADEMIC_RANK_CREATE_SUCCESS_MESSAGE;
				}
			})
			.catch((error) => {
				console.log(error);
...
function updateAcademicRank(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.updateAcademicRank(updatedAcademicRank)
			.then((academicRank) => {
			...
			.catch((error) => {
				if (null === error) {
					responseJson.code =
						messageConstants.CONFIG_ACADEMIC_RANK_UPDATED_NOT_EXISTS_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACADEMIC_RANK_UPDATED_NOT_EXISTS_MESSAGE;
					error =
						messageConstants.CONFIG_ACADEMIC_RANK_UPDATED_NOT_EXISTS_MESSAGE;
				}
				console.log(error);
		...
		configurationService
			...
			.then((deleteCount) => {
				...
				if (deleteCount === originalSize) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACADEMIC_RANK_DELETE_SUCCESS_MESSAGE;
				} else {
					responseJson.code =
						messageConstants.CONFIG_ACADEMIC_RANK_DELETED_NOT_ALL_CODE;
...
function getAcademicTitlesWithPagination(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.getAcademicTitleWithPagination(pageOffset, limitSize)
			.then((academicTitles) => {
				//If there is a not-null academic titles => change the response's data
				if (academicTitles) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACADEMIC_TITLE_SUCCESS_MESSAGE;
...
function createAcademicTitles(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.createAcademicTitles(data)
			.then((academicTitleIds) => {
				//If there is a not empty id array => change the response's data
				if (academicTitleIds.length > 0) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACADEMIC_TITLE_CREATE_SUCCESS_MESSAGE;
				}
			})
			.catch((error) => {
				console.log(error);
...
function updateAcademicTitle(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.updateAcademicTitle(updatedAcademicTitle)
			.then((academicTitle) => {
			...
			.catch((error) => {
				if (null === error) {
					responseJson.code =
						messageConstants.CONFIG_ACADEMIC_TITLE_UPDATED_NOT_EXISTS_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACADEMIC_TITLE_UPDATED_NOT_EXISTS_MESSAGE;
					error =
						messageConstants.CONFIG_ACADEMIC_TITLE_UPDATED_NOT_EXISTS_MESSAGE;
				}
				console.log(error);
		...
		configurationService
			...
			.then((deleteCount) => {
				...
				if (deleteCount === originalSize) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACADEMIC_TITLE_DELETE_SUCCESS_MESSAGE;
				} else {
					responseJson.code =
						messageConstants.CONFIG_ACADEMIC_TITLE_DELETED_NOT_ALL_CODE;
...
function getTagsWithPagination(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.getTagWithPagination(pageOffset, limitSize)
			.then((tags) => {
		...
		configurationService
			...
			.then((tagIds) => {
				...
				if (tagIds.length > 0) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_TAG_CREATE_SUCCESS_MESSAGE;
				}
			})
			.catch((error) => {
				console.log(error);
	...
	return new Promise((resolve, reject) => {
		...
		configurationService
			...
			.catch((error) => {
				if (null === error) {
					responseJson.code =
						messageConstants.CONFIG_TAG_UPDATED_NOT_EXISTS_CODE;
					responseJson.message =
						messageConstants.CONFIG_TAG_UPDATED_NOT_EXISTS_MESSAGE;
		...
		configurationService
			...
			.then((deleteCount) => {
				...
				if (deleteCount === originalSize) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_TAG_DELETE_SUCCESS_MESSAGE;
				} else {
...
function getActivityTypesWithPagination(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.getActivityTypeWithPagination(pageOffset, limitSize)
			.then((activityTypes) => {
				//If there is a not-null activity types => change the response's data
				if (activityTypes) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACTIVITY_TYPE_SUCCESS_MESSAGE;
...
function createActivityTypes(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.createActivityTypes(data)
			.then((activityTypeIds) => {
				//If there is a not empty id array => change the response's data
				if (activityTypeIds.length > 0) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACTIVITY_TYPE_CREATE_SUCCESS_MESSAGE;
				}
			})
			.catch((error) => {
				console.log(error);
...
function updateActivityType(request, response) {
	return new Promise((resolve, reject) => {
		...
		configurationService
			.updateActivityType(updatedActivityType)
			.then((activityType) => {
			...
			.catch((error) => {
				if (null === error) {
					responseJson.code =
						messageConstants.CONFIG_ACTIVITY_TYPE_UPDATED_NOT_EXISTS_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACTIVITY_TYPE_UPDATED_NOT_EXISTS_MESSAGE;
					error =
						messageConstants.CONFIG_ACTIVITY_TYPE_UPDATED_NOT_EXISTS_MESSAGE;
				}
				console.log(error);
		...
		configurationService
			...
			.then((deleteCount) => {
				...
				if (deleteCount === originalSize) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_ACTIVITY_TYPE_DELETE_SUCCESS_MESSAGE;
				} else {
					responseJson.code =
						messageConstants.CONFIG_ACTIVITY_TYPE_DELETED_NOT_ALL_CODE;
...
function getUniversitiesWithPagination(request, response) {
	return new Promise((resolve, reject) => {
		...
		//Try to get all the activity types from the database
		configurationService
			.getUniversityWithPagination(pageOffset, limitSize)
			.then((universities) => {
				//If there is a not-null activity types => change the response's data
				if (universities) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
		...
		configurationService
			...
			.then((universityIds) => {
				...
				if (universityIds.length > 0) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_UNIVERSITY_CREATE_SUCCESS_MESSAGE;
				}
			})
			.catch((error) => {
				console.log(error);
	...
	return new Promise((resolve, reject) => {
		...
		configurationService
			...
			.catch((error) => {
				if (null === error) {
					responseJson.code =
						messageConstants.CONFIG_UNIVERSITY_UPDATED_NOT_EXISTS_CODE;
					responseJson.message =
						messageConstants.CONFIG_UNIVERSITY_UPDATED_NOT_EXISTS_MESSAGE;
		...
		configurationService
			...
			.then((deleteCount) => {
				...
				if (deleteCount === originalSize) {
					responseJson.code = messageConstants.SUCCESSFUL_CODE;
					responseJson.message =
						messageConstants.CONFIG_UNIVERSITY_DELETE_SUCCESS_MESSAGE;
				} else {
					responseJson.code =
						messageConstants.CONFIG_UNIVERSITY_DELETED_NOT_ALL_CODE;
